#!/usr/bin/env python
# Source: https://github.com/OALabs/hashdb/blob/main/algorithms/conti_b801fcda.py
# License: Apache-2.0
SOURCE = 'https://github.com/OALabs/hashdb/blob/main/algorithms/conti_b801fcda.py'
LICENSE = "Apache-2.0"
...
DESCRIPTION = "Conti ransomware api hash with seed 0xB801FCDA"
TYPE = 'unsigned_int'
TEST_1 = 384343055
...
def hash(data):
    ...
    if len(data) >= 4:
        ...
        while True:
            ...
            API_buffer_count += 4
            v15 = ((0x5BD1E995 * (temp ^
                                  (shr32(temp, 0x18)))) & 0xFFFFFFFF) ^ ((0x5BD1E995 * v15) & 0xFFFFFFFF)
            count -= 1
            if count == 0:
                break
